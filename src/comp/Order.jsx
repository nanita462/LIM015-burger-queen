        ...
        <>
            <div data-testid="order-comp">
                ...
                <div className="menu-order-btns">
                    <Button onClick={props.onClickCancel} class="cancel-btn" label="Cancelar" />
